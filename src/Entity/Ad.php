 ...
 * @UniqueEntity(fields="title", message="Une annonce avec ce titre existe déjà")
 */
class Ad
{
    /**
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractères", maxMessage="Le titre ne put pas faire plus de 255 caractères")
     */
    private $title;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Image", mappedBy="ad", orphanRemoval=true, cascade={"persist","remove"})
     * @Assert\Valid()
     */
    private $images;

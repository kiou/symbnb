 ...
 * @UniqueEntity(fields="email", message="Un uatre c'est déjà inscrit avec cette adresse email, merci de la modifier")
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Email(message="Veuillez renseigner un emaile valide")
     */
    private $email;
